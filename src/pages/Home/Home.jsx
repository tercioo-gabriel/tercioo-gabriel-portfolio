        ...
        <div className="flex flex-col justify-between max-w-6xl min-h-72 gap-14 lg:gap-0">
          ...
          <div className="text-sm lg:text-base flex flex-col gap-3">
            ...
            <span className="flex flex-col xs:flex-row xs:gap-3">
              ...
              <a className="text-orange-400 hover:text-orange-500 text-wrap" download="curriculo-tercio-gabriel.pdf" href="/curriculo-tercio-gabriel.pdf">"https://tercioo-gabriel.com/download-curriculo"</a>
              </span>
          </div>
        </div>
