...
const AboutMe = () => {
  return(
    <div className="flex flex-col sm:flex-row h-screen">
      <div className="sm:h-full w-full border-b sm:min-w-[209px] md:min-w-[289px] lg:min-w-[305px] sm:max-w-[209px] md:max-w-[289px] lg:max-w-[305px] text-wrap text-sm md:text-base sm:border-r sm:border-b-0 border-gray-border border-opacity-70">
        <span className="flex items-center sm:items-start md:items-center mt-14 px-4 py-2 sm:py-3 border-gray-border border-b border-opacity-70">
